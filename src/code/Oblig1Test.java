...
Som utgangspunkt er metodekallene kommentert vekk. Her mÃ¥ en passe pÃ¥
Ã¥ bruke nÃ¸yaktig samme navn pÃ¥ metodene som det er bedt om i oppgaveteksten.

NÃ¥r en mener at en oppgave/metode er lÃ¸st, bÃ¸r en fÃ¸rst teste med egne tester.
NÃ¥r en sÃ¥ tror at koden er feilfri, kan testprogrammet brukes ved at
kommentartegnet foran metodekallet tas vekk. Testprogrammet mÃ¥ gi 0 feil fÃ¸r
Oblig 1 sendes inn!
*/
...
public class Oblig1Test {
    public static void main(String[] args) {
        ...
        if (antallFeil == 0) {
            ...
            System.out.println("MÃ¥ forbedres! Du har minst "
...
///// Oppgave 2 //////////////////////////////////////
    ...
    public static int oppgave4() {
        ...
        if (!Arrays.equals(a, b)) {
            System.out.println
                    ("Oppgave 4: c) Metoden gjÃ¸r feil for en tabell en verdi!");
            antallFeil++;
        }
        ...
        if (!Arrays.equals(a, b)) {
            System.out.println
                    ("Oppgave 4: e) Metoden gjÃ¸r feil for en tabell en verdi!");
            antallFeil++;
        }
        ...
        try {
            ...
            System.out.println
                    ("Oppgave 4: f) Det gÃ¥r galt hvis det kun er partall!");
            antallFeil++;
        }
        ...
        try {
            ...
            System.out.println
                    ("Oppgave 4: h) Det gÃ¥r galt hvis det kun er oddetall!");
            antallFeil++;
        }
        ...
        if (!Arrays.equals(a, b)) {
            System.out.println
                    ("Oppgave 4: l) Metoden gjÃ¸r feil for negative verdier!");
            antallFeil++;
        }
    ...
    public static int oppgave6() {
        ...
        if (tid > 20) {
            System.out.println("Oppgave 6: i) Metoden "
                    + "er for ineffektiv. MÃ¥ forbedres!");
            antallFeil++;
        }
    ...
    public static int oppgave8() {
        ...
        if (indeks[0] != 0) {
            System.out.println
                    ("Opgave 8: e) indeks[0] skal vÃ¦re lik 0!");
            antallFeil++;
        }
        ...
        do {
            ...
            if (!Arrays.equals(a, c)) {
                System.out.println
                        ("Oppgave 8: f) Tabellen fÃ¸r kallet:   " + Arrays.toString(a));
                System.out.println
        ...
        if (!Arrays.equals(a, c)) {
            System.out.println
                    ("Oppgave 8: h) Parametertabellen endres nÃ¥r den er lik");
            System.out.println
                    ("            " + Arrays.toString(a));
    ...
    public static int oppgave9() {
        ...
        if (!unntak) {
            System.out.println
                    ("Opgave 9: b) Det skal kastes unntak for tabeller med for fÃ¥ verdier!");
            antallFeil++;
        }
        ...
        if (!Arrays.equals(x, y)) {
            System.out.println
                    ("Oppgave 9: e) Metoden gjÃ¸r endringer i tabellen!");
            System.out.println("Tabellen fÃ¸r: " + Arrays.toString(y));
        ...
        if (tid > 100) {
            ...
            System.out.println("metoden indekssortering pÃ¥ hele tabellen?");
            antallFeil++;
        }
    ...
    public static int[] randPerm(int n)  // en effektiv versjon
    {
        ...
        for (int k = n - 1; k > 0; k--)  // lÃ¸kke som gÃ¥r n - 1 ganger
        {
