...
class MergeTests {
    ...
    void firstStringPointingToNullTest() {
        ...
        assertThrows(NullPointerException.class, () -> { Oblig1.merge(firstString, secondString); });
    }
    ...
    void firstStringEmptyTest() {
        ...
        assertEquals("Example string", Oblig1.merge(firstString, secondString));
    }
    ...
    void bothStringsEmptyTest() {
        String firstString = "";
        String secondString = "";
        assertEquals("", Oblig1.merge(firstString, secondString));
    }
    ...
    void firstStringLongerThanSecondStringTest() {
        ...
        assertEquals("AOBPCQDREFGHIJKL", Oblig1.merge(firstString, secondString));
    }
    ...
    void secondStringLongerThanFirstStringTest() {
        ...
        assertEquals("AOBPCQRSTUVWXYZ", Oblig1.merge(firstString, secondString));
    }
    ...
    void firstAndSecondStringEquallyLongTest() {
        ...
        String secondString = "OPQR";
        assertEquals("AOBPCQDR", Oblig1.merge(firstString, secondString));
    }
    ...
    void firstStringIncludesUnicodeTest() {
        ...
        assertEquals("ÆAØBÅC", Oblig1.merge(firstString, secondString));
    }
    ...
    void secondStringIncludesUnicodeTest() {
        ...
        assertEquals("AÆBØCÅ", Oblig1.merge(firstString, secondString));
    }
    ...
    void bothStringIncludeUnicodeTest() {
        ...
        assertEquals("AOBÅÆPCQØÆ", Oblig1.merge(firstString, secondString));
    }
