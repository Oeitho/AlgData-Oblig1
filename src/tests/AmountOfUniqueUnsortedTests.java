...
class AmountOfUniqueUnSortedTests {
    ...
    void emptyArrayTest() {
        int[] emptyArray = {};
        assertEquals(0, Oblig1.amountOfUniqueUnsorted(emptyArray));
    }
    
    @Test
    void arrayPointingToNullTest() {
        int[] arrayPointingToNull = null;
        assertThrows(NullPointerException.class, () -> Oblig1.amountOfUniqueUnsorted(arrayPointingToNull));
    }
    
    @Test
    void arrayWithOneElementTest() {
        int[] arrayWithOneElement = {4};
        assertEquals(1, Oblig1.amountOfUniqueUnsorted(arrayWithOneElement));
    }
    
    @Test
    void negativeNumbersTest() {
        int[] arrayOfNegativeIntegers = {-20, -20, -14, -13, -13, -13, -3};
        assertEquals(4, Oblig1.amountOfUniqueUnsorted(arrayOfNegativeIntegers));
    }
    
    @Test
    void mixedNegativeAndPositiveIntegersTest() {
        int[] arrayOfIntegers = {-20, -14, -10, 0, 19, 20};
        assertEquals(6, Oblig1.amountOfUniqueUnsorted(arrayOfIntegers));
    }
