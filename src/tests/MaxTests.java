...
class maxTest {
    ...
    void emptyArrayTest() {
        int[] emptyArray = {};
        assertThrows(NoSuchElementException.class, () -> Oblig1.max(emptyArray));
    }
    ...
    void negativeNumbersTest() {
        ...
        assertEquals(-1, Oblig1.max(arrayOfNegativeIntegers));
    }
    
    @Test
    void mixedNegativeAndPositiveIntegersTest() {
        int[] arrayOfIntegers = {-20, 20, 14, -1, 0, 100};
        assertEquals(100, Oblig1.max(arrayOfIntegers));
    }
