...
class StringContainsTests {
    ...
    void firstStringPointsToNullTest() {
        ...
        assertThrows(NullPointerException.class, () -> Oblig1.stringContains(firstString, secondString));
    }
    ...
    void firstStringEmptyTest() {
        String firstString = "";
        String secondString = "ABBA";
        assertEquals(true, Oblig1.stringContains(firstString, secondString));
    }
    ...
    void secondStringEmptyTest() {
        String firstString = "ABBA";
        String secondString = "";
        assertEquals(false, Oblig1.stringContains(firstString, secondString));
    }
